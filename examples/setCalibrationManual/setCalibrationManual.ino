 ...
 *  Если Вы желаете указать среднее значение АЦП для каждого датчика модуля, то обратитесь к функции setCalibrationManual() указав семь значений.
 *  
 *  setCalibrationManual(АЦП для всех датчивов модуля);
 *  setCalibrationManual(АЦП 1 датчика, АЦП 2 датчика, АЦП 3 датчика, АЦП 4 датчика, АЦП 5 датчика, АЦП 6 датчика, АЦП 7 датчика);
 */ 