...
//  f=bum.setCalibrationManual(800,650,750,700,600,800,700,750,650); //   Выполняем калибровку указав значение АЦП между фоном и линией для каждого датчика модуля.
//  Для модулей версии 6 указываем значение 700 (+-400).             //
//  Для модулей версии 7 указываем значение  80 (+-50 ).             //
